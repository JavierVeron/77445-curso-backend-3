...
Se incluyen detalles sobre cómo construir la imagen, ejecutar el contenedor y cualquier otra información relevante para los usuarios que deseen utilizar la imagen de Dockerhub.